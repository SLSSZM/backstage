  ...
  <div class="users">
    ...
    <el-card>
      ...
      <el-table :data="userList" border stripe>
        <el-table-column type="index" laber="#" align="center"></el-table-column>
        ...
        <el-table-column label="操作">
          <template v-slot="scope">
            ...
            <el-tooltip effect="dark" content="编辑" placement="top" :enterable="false">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="showEditDialog(scope.row._id)">
              </el-button>
            </el-tooltip>
            <!-- 删除按钮 -->
            <el-tooltip effect="dark" content="删除" placement="top" :enterable="false">
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="showDeleteDialog(scope.row._id)">
              </el-button>
            </el-tooltip>
            <!-- 设置角色按钮 -->
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogColse">
      <!-- 内容区 -->
      <el-form :model="addUserData" :rules="addUserRules" ref="addUserRef" label-width="80px">
    ...
    <!-- 编辑用户对话框 -->
    <el-dialog title="编辑用户" :visible.sync="editDialogVisible" ref="editUserRef" width="50%" @close="editDialogClosed">
      <!-- 内容区 -->
...
export default {
  ...
  methods: {
    ...
    async saveRole () {
      ...
      const { data: res } = await this.$http.put(`/users/${this.userInfo._id}/roles`, { rid: this.selectRoleId });
      if (res.meta.status !== 201) {
        return this.$message.error(res.meta.msg);
      }
      this.$message.success(res.meta.msg);
